...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cdr_userprofile', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cdr.Company'], unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.company'
        db.alter_column('cdr_userprofile', 'company_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['Company.Company'], unique=True, null=True))
