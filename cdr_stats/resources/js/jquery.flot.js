    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                fragments.push(
                    '<td class="span-1"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:16px;height:0;border:5px solid ' + s.color + ';overflow:hidden"></div></div></td>' +
                    '<td class="span-2 last">' + label + '</td>');
            }
            if (rowStarted)
                fragments.push('</tr>');
            ...
            var table = '<div class="span-3"><table style="font-size:smaller;color:' + options.grid.color + '">' + fragments.join("") + '</table></div>';
